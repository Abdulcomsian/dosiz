				...
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li>
							<a href="<?php echo e(route('dashboard')); ?>" target="_blank">Admin</a>
							</li>
							<li class="login-link">
					...
					<?php if(Route::is(['pagee','mentor-register','mentee-register'])): ?>
						...
						<li class="nav-item">
							<a class="nav-link header-login" href="<?php echo e(route('register')); ?>">Register</a>
						</li>
						<?php endif; ?>
						<?php if(!Route::is(['pagee','mentor-register','mentee-register'])): ?>
...
<?php /**PATH /Applications/Development/Web/Laravel/dosiz/resources/views/layout/partials/header.blade.php ENDPATH**/ ?>