...
<section id="articleSection" class="articleCategory">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
            <div class="badgeDiv">
                                <img src="<?php echo e(asset('assets/img/user/badge.png')); ?>" alt="">
                                <span class="whishlistText">
                                    <span>0</span>
                                    <img src="<?php echo e(asset('assets/img/user/heart.png')); ?>" alt="">
                                </span>
                            </div>
                <img src="<?php echo e(asset('assets/img/user/articleMain.png')); ?>" alt="" class="img-fluid">
            </div>
            <div class="col-md-6">
            ...
            <div class="multiDiv">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <img src="<?php echo e(asset('assets/img/user/articleCategory.png')); ?>" alt="" class="img-fluid">
                            <div class="articleInfo">
                                <div class="dateInput">
                                    <input type="date">
                                </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/Development/Web/Laravel/dosiz/resources/views/user/articleCategory.blade.php ENDPATH**/ ?>