                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-body">
								<a class="btn btn-primary" href="<?php echo e(url('admin/add-product')); ?>">Add Product</a><br><br>
											...
											<tbody>
												<tr>
													...
													<td class="text-center">
														<p>A descriptive paragraph is a focused and detail-rich </p>
													</td>
												...
												<tr>
													...
													<td class="text-center">
														<p>A descriptive paragraph is a focused and </p>
													</td>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecommerce-rtl\resources\views/admin/categories.blade.php ENDPATH**/ ?>