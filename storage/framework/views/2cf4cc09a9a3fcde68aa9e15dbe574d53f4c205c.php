										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td> <img src="<?php echo e(asset($product->image)); ?>" width="100px" height="100px"></td>
													...
													<td class="text-right">
														<div class="actions" style="display:flex;">
															...
															<a href="<?php echo e(route('product.show',$product->id)); ?>" target="_blank" style="height: 33px; margin-left: 10px" class="btn btn-sm bg-primary-light edit-product"><i class="fe fe-eye"></i> Show</a>
															<a href="<?php echo e(route('product.edit',$product->id)); ?>" style="height: 33px; margin-left: 10px" class="btn btn-sm bg-success-light edit-product"><i class="fe fe-pencil"></i> Edit</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dosiz\resources\views/product/index.blade.php ENDPATH**/ ?>