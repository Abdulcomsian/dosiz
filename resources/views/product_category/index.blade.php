									...
									<div class="table-responsive">
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right">
														<div class="actions" style="display:flex;">
															<a class="btn btn-sm bg-success-light edit-category" style="height: 33px; margin-left: 10px" onclick="edit_cat({{$p_category}})">
															...
															<form method="POST" action="{{ route('category.destroy', $p_category->id) }}"  id="form_{{$p_category->id}}" >
							                                    ...
							                                    <button type="submit" id="{{$p_category->id}}" class="confirm btn btn-sm bg-danger-light btn-active-color-primary btn-sm">
												...
												@else
												<tr>
						                        <td colspan="3" style="text-align: center;"><strong> No Product Category </strong></td>
						                      </tr>
						                      @endif
						                    <tbody>
