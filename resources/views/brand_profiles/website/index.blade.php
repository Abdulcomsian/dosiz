                ...
                <div class="articleRightDiv">
                    <div class="articleCard">
                        ...
                        <div class="articleInfo">
                            ...
                            <p> {!! \Illuminate\Support\Str::limit($blog_1->description, 200, $end='...') !!} </p>
                            <div class="readMore">
                                <p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="articleInfo">
                                    ...
                                    <p> {!! \Illuminate\Support\Str::limit($blog_2->description, 200, $end='...') !!} </p>
                                    <div class="readMore">
                                        <p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="articleInfo">
                                    ...
                                    <p>{!! \Illuminate\Support\Str::limit($blog_3->description, 200, $end='...') !!} </p>
                                    <div class="readMore">
                                        <p>
