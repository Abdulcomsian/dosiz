										...
										<div class="col-12 blog-details">
											<form action="{{ route('product.store') }}" enctype="multipart/form-data" method="post">
					                            ...
					                            <div class="form-group">
					                                ...
					                                <div>
					                                    <input class="form-control" type="number" name="price" id="price" placeholder="Enter Orignal Price">
						                        ...
						                        <div class="form-group">
					                                ...
					                                <div>
					                                    <input class="form-control" type="number" name="discount_price" id="discount_price" placeholder="Enter Discount Price">
